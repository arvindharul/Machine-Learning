...
a3 = sigmoid(z3); %Dimension 5000x10

hThetaX = a3; %Dimension 5000x10

yVec = zeros(m,num_labels); %Dimension 5000x10

for i = 1:m
    yVec(i,y(i)) = 1;
end

% We multiply element wise and add all the elements together to find the cost
% The first sum does it over the column. So we get a set of numbers which again add up together
